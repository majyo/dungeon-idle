    ...
    buildings: [
      {
        ...
        maxLevel: 3,
        levels: [
          { materials: [{ itemId: 'oak-wood', name: '橡木', amount: 5 }, { itemId: 'copper', name: '铜矿', amount: 3 }], time: 3000 },
          { materials: [{ itemId: 'pine-wood', name: '松木', amount: 10 }, { itemId: 'iron', name: '铁矿', amount: 5 }], time: 4000 },
          { materials: [{ itemId: 'birch-wood', name: '桦木', amount: 15 }, { itemId: 'silver', name: '银矿', amount: 8 }], time: 5000 },
        ],
      },
      {
        id: 'tavern',
        ...
        maxLevel: 3,
        levels: [
          { materials: [{ itemId: 'oak-wood', name: '橡木', amount: 8 }, { itemId: 'copper', name: '铜矿', amount: 2 }], time: 3500 },
          { materials: [{ itemId: 'pine-wood', name: '松木', amount: 12 }, { itemId: 'iron', name: '铁矿', amount: 6 }], time: 4500 },
          { materials: [{ itemId: 'birch-wood', name: '桦木', amount: 20 }, { itemId: 'silver', name: '银矿', amount: 10 }], time: 5500 },
        ],
      },
      {
        id: 'general-store',
        ...
        maxLevel: 3,
        levels: [
          { materials: [{ itemId: 'oak-wood', name: '橡木', amount: 6 }, { itemId: 'copper', name: '铜矿', amount: 4 }], time: 3000 },
          { materials: [{ itemId: 'pine-wood', name: '松木', amount: 10 }, { itemId: 'iron', name: '铁矿', amount: 8 }], time: 4000 },
